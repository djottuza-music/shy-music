import { ArrowDown, ArrowUp, ChevronDown, ChevronUp, Download, Heart, ListMusic, Mic2, Pause, Play, Repeat2, Shuffle, SkipBack, SkipForward, Volume1, Volume2, X } from 'lucide-react'
...
export function GlobalPlayer() {
  ...
  return <>
    ...
    {player.expanded && <div className="now-playing" role="dialog" aria-modal="true" aria-label="Now playing view">
      ...
      <div className="now-social"><CurrentTrackLike trackId={player.current.id} /></div>
