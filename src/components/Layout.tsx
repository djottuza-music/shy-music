...
export function Layout() {
  ...
  return <div className="app-shell">
    ...
    <main className="page"><PageBoundary key={location.pathname}><Suspense fallback={<LoadingState label="Opening page..." />}><Outlet /></Suspense></PageBoundary></main>
